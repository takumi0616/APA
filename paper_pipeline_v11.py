...
PIPELINE_DEFAULTS: dict[str, Any] = {
    ...
    "warp": {
        ...
        "min_inlier_ratio": 0.12,  # warpを許可する最小inlier_ratio
...
def process_one_case(
    *,
    ...
    try:
        res2, H2, mk0, mk1 = matcher.match_and_estimate_h(tpl_bgr, chosen_for_match)
        ...
        if getattr(res2, "ok", False) and mk0 is not None and mk1 is not None:
            dbg = draw_inlier_matches(tpl_bgr, chosen_for_match, mk0, mk1, args.match_max_side)
